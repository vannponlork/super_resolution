...
def load_model(dirs,ext):
    ...
    file_name = os.path.join(d,files[0])

    print("The model to restore:", count)
    print("Model to restore:",file_name)
...
def load_data_from_dirs(dirs, ext):
    ...
    print("The images to train are:", count_availlable)
    return files, count_availlable
#=============================================================
...
def load_training_data(directory, ext, number_of_images=1000, train_test_ratio = 0.8):
    files, number_of_images = load_data_from_dirs(load_path(directory), ext)
